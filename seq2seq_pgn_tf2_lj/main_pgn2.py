...
from seq2seq_pgn_tf2_lj.test import predict_result
from seq2seq_pgn_tf2_lj.train import train
import argparse

from seq2seq_pgn_tf2_lj.utils.config import train_x_seg_path, train_y_seg_path, test_x_seg_path, batch_size, save_result_dir, \
    vocab_path, epochs, checkpoint_dir, val_x_seg_path, val_y_seg_path
from seq2seq_pgn_tf2_lj.utils.file_utils import get_result_filename
...
def main():
    ...
    parser.add_argument("--gpu_memory", default=9, help="gpu_memory GB", type=int)
