...
from seq2seq_pgn_tf2_lj.utils.config import embedding_matrix_path, vocab_path, save_wv_model_path, embedding_dim
...
def load_embedding_matrix(filepath=embedding_matrix_path, max_vocab_size=30000):
    """
...
if __name__ == '__main__':
    ...
    # 只抽取3000个词的词向量
    embedding_matrix = load_embedding_matrix(embedding_matrix_path, max_vocab_size=3000)
