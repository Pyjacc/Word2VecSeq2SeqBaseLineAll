...
from seq2seq_tf2_d.utils import training
from seq2seq_tf2_d.utils.testing import test_and_save
...
def params_set():
    ...
    # 设置模型参数
    parser.add_argument("--seq2seq_model_dir", default=str(root)+'/seq2seq_tf2_d/dataSetsSeq2Seq/ckpt/seq2seq',
                        help="Model folder")
    parser.add_argument("--model_path", default="", type=str,
                        help="Path to a specific model")
    parser.add_argument("--train_seg_x_dir", default=str(root)+'/seq2seq_tf2_d/dataSetsSeq2Seq/train_set_seg_x.txt',
                        help="train_seg_x_dir")
    parser.add_argument("--train_seg_y_dir", default=str(root)+'/seq2seq_tf2_d/dataSetsSeq2Seq/train_set_seg_y.txt',
                        help="train_seg_y_dir")
    parser.add_argument("--test_seg_x_dir", default=str(root)+'/seq2seq_tf2_d/dataSetsSeq2Seq/test_set_seg_x.txt',
                        help="test_seg_x_dir")
    parser.add_argument("--vocab_path", default=str(root)+'/seq2seq_tf2_d/dataSetsSeq2Seq/vocab.txt',
                        help="Vocab path")
    parser.add_argument("--word2vec_output", default=str(root)+'/seq2seq_tf2_d/dataSetsSeq2Seq/word2vec.txt',
                        help="Vocab path")
    parser.add_argument("--test_save_dir", default=str(root)+'/seq2seq_tf2_d/dataSetsSeq2Seq/',
                        help="test_save_dir")
    parser.add_argument("--test_file_path", default=str(root) + '/seq2seq_tf2_d/dataSetsSeq2Seq/test.csv',
                        help="test_file_path")
    parser.add_argument("--test_result_path", default=str(root) + '/seq2seq_tf2_d/dataSetsSeq2Seq/test_results.csv',
    ...
    parser.add_argument("--steps_per_epoch", default=5000, type=int, help="max_train_steps")
